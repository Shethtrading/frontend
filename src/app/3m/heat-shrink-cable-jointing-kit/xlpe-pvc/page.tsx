...
export default function Component() {
  ...
  const [coreOptions, setCoreOptions] = useState(['1 core', '3 core'])
  ...
  useEffect(() => {
    if (formData.voltage === '1.1KV(E)') {
      setCoreOptions(['1 core', '2 core', '3 core', '4 core'])
    } else {
      setCoreOptions(['1 core', '3 core'])
    }
  }, [formData.voltage])
        ...
        <CardContent className="p-0">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-6 space-y-6">
              <div>
                <h1 className="text-3xl font-bold mb-2">XLPE/PVC</h1>
